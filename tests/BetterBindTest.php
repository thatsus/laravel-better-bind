...
class BetterBindTest extends TestCase
{
    ...
    {
        $object = new stdClass();
        $this->appBind(MyBindTest_NeedNoParams::class, function () use ($object) { return $object; }, $params);
        $got = App::makeWith(MyBindTest_NeedNoParams::class, []);
        $this->assertEquals($object, $got);
        $this->assertCount(0, $params);
    }
    ...
    public function testBindHeadlessClassWithParams()
    {
        ...
        $this->appBind(MyBindTest_NeedNoParams::class, function () use ($object) { return $object; }, $params);
        try {
            App::makeWith(MyBindTest_NeedNoParams::class, ['y' => 'z']);
        } catch (PHPUnit_Framework_ExpectationFailedException $e) {
        }
        $this->assertNotNull($e);
        $this->assertRegExp('/MyBindTest_NeedNoParams/', $e->getMessage());
    ...
    {
        $object = new stdClass();
        $this->appBind(MyBindTest_NeedParams::class, function () use ($object) { return $object; }, $params);
        $got = App::makeWith(MyBindTest_NeedParams::class, ['first_param' => 123, 'second_param' => 456]);
        $this->assertEquals($object, $got);
    ...
    public function testBindHeadfulClassWithOneParam()
    {
        $object = new stdClass();
        $this->appBind(MyBindTest_NeedParams::class, function () use ($object) { return $object; }, $params);
        $got = App::makeWith(MyBindTest_NeedParams::class, ['first_param' => 123]);
        $this->assertEquals($object, $got);
        $this->assertEquals(123, $params['first_param']);
        $this->assertCount(1, $params);
    }
    ...
    public function testBindHeadfulClassNoParams()
    {
        ...
        $this->appBind(MyBindTest_NeedParams::class, function () use ($object) { return $object; }, $params);
        try {
            App::makeWith(MyBindTest_NeedParams::class, []);   
        } catch (PHPUnit_Framework_ExpectationFailedException $e) {
        }
        $this->assertNotNull($e);
        $this->assertRegExp('/MyBindTest_NeedParams/', $e->getMessage());
    ...
    public function testBindHeadfulClassWithTooManyParams()
    {
        ...
        $this->appBind(MyBindTest_NeedParams::class, function () use ($object) { return $object; }, $params);
        try {
            App::makeWith(MyBindTest_NeedParams::class, ['first_param' => 123, 'second_param' => 456, 'failure_param' => 789]);   
        } catch (PHPUnit_Framework_ExpectationFailedException $e) {
        }
        $this->assertNotNull($e);
        $this->assertRegExp('/MyBindTest_NeedParams/', $e->getMessage());
...
class MyBindTest_NeedNoParams
{
}

class MyBindTest_NeedParams
{
